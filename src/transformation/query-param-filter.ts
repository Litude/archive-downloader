...
type FilterCondition = ExistsCondition | MatchesCondition | AndCondition | OrCondition | NotCondition;

interface QueryParamFilterOptions {
    condition: FilterCondition;
}

function evaluateCondition(condition: FilterCondition, queryParams: Record<string, string | null>): boolean {
