...
describe("parseIisEtagDate", () => {
  ...
  it("parses agexonzone.gif etag (Last-Modified: 1999-01-03T09:06:58Z)", () => {
    ...
    const result = parseIisEtagDate('"065876af836be1:7f6"', captureAt("2000-05-19T20:22:13Z"));
  ...
  it("returns all possible values if multiple - parses ensemble_logo.gif etag (Last-Modified: 1999-01-03T10:34:20Z)", () => {
    ...
    const result = parseIisEtagDate('"01e19f437be1:43a8"', captureAt("2000-07-28T18:01:57Z"));
    expect(result).not.toBeNull();
  ...
  it("parses trans.gif etag (Last-Modified: 1999-01-07T03:55:00Z)", () => {
    ...
    const result = parseIisEtagDate('"042627ff139be1:7f6"', captureAt("2000-05-19T06:21:50Z"));
    expect(result).not.toBeNull();
  ...
  it("parses user example 1 (Last-Modified: 1999-11-09T16:49:08Z)", () => {
    ...
    const result = parseIisEtagDate('"ba9d5657d22abf1:7ed"', captureAt("2000-01-01T00:00:00Z"));
    expect(result).not.toBeNull();
  ...
  it("parses user example 2 (Last-Modified: 1999-12-21T15:24:34Z)", () => {
    ...
    const result = parseIisEtagDate('"fe53497cc74bbf1:9b5e7"', captureAt("2000-01-01T00:00:00Z"));
    expect(result).not.toBeNull();
